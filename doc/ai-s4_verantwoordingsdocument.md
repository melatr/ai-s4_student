# Verantwoordingsdocument[](title-id) <br> Deep Learning (AI-S4)
...
> De student analyseert een probleem van een externe opdrachtgever door het probleemtype te identificeren (zoals beeldclassificatie, taalgeneratie, beslissysteem, et cetera) en de haalbaarheid en wenselijkheid van deep learning te bepalen en de opdrachtgever hierover te adviseren.
...
> De student analyseert de beschikbare data en prepareert een dataset voor het trainen van een deep learning model, waarbij rekening wordt gehouden met privacyaspecten.
...
> De student beredeneert op basis van de werking van deep learning algoritmen en -technieken (zoals backpropagation en vector embeddings) of een deep learning model toepasbaar is op een gegeven probleem.
...
> De student ontwerpt en realiseert een deep learning applicatie die voldoet aan de gestelde eisen, rekening houdend met het gebruik van bestaande modellen.
...
> De student analyseert de effectiviteit van een deep learning model, interpreteert de resultaten van het model en adviseert over verbeteringen.
